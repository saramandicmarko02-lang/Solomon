...
export function EnrollmentPage() {
  ...
  return (
    <div className="animate-fade-up max-w-[720px] px-7 py-[26px] pb-12">
      ...
      <div className="mt-[22px] flex flex-col gap-4">
        ...
        <Card className="px-5 pb-2 pt-1">
          <div className="py-3.5 text-sm font-semibold">Stanje agenta</div>
          ...
          <KvRow label="Hostname">
            <span className="font-mono text-[12.5px]">{data.hostname ?? "—"}</span>
          </KvRow>
          <KvRow label="Solomon verzija">
            <span className="font-mono text-[12.5px]">{data.solomonVersion ?? "—"}</span>
          </KvRow>
